      ...
      <script type="text/javascript" src="{{ URL::asset('js/mypage.js') }}" defer></script>
        ...
        <div id="wrapper">
            ...
            <div id="content">
              ...
              <form action="/findPwSubmit" id="findpwform"  method="post" >
                @csrf
                <!-- ID -->
                <div>
                    <h3 class="join_title">
                ...
                <center><div class="btn_area">
                    <button type="submit" id="findpwformBtn" class="find-result">
                        <span>인증번호 받기</span>
                    </button>
                </div></center>
            </form>

            <form action="/findPwchg" method="post">
              @csrf
            <div>
              <span class="box int_email">
                  <input type="text" id="authinput" class="int" maxlength="100" name="code" placeholder="인증번호 입력" disabled="disabled">
              </span>  
          </div>  
     
          <center><div class="btn_area">
            <button type="submit" class="find-result" id="next">
                <span>다음으로</span>
            </button>
        </div></center>
        </form>
